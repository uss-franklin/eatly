      ...
      <div className="aboutMeSectionContainer"> 	
      	...
      	<div className="generalInfoAppTextContainer">
      		...
      		<p className="generalInfoAppText">
      			...
      			eatly is a place to plan group meals. Every guest gets to vote on the restaurants they most want to eat at, keeping the process fair and free of bother.
      		</p>
      	</div>
      	...
      	<div className="magicOfEatlyTextContainer">
      		<h1 className="magicOfEatlyTextHeader">
      			Never waste time organizing nights out. Less planning, more eating!
      		</h1>

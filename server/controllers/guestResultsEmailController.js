...
*/
const mailOptions = function(email, hostName, eventDate, eventName, eventLocation, userId, eventId) {
 return {
          ...
          <td class="container" style="font-family: sans-serif; font-size: 14px; vertical-align: top; display: block; Margin: 0 auto; max-width: 580px; padding: 10px; width: 580px;">
            <div class="content" style="box-sizing: border-box; display: block; Margin: 0 auto; max-width: 580px; padding: 10px;">
              ...
              <span class="preheader" style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">
                Get ready to feast with ${hostName} and friends!</span>
                      ...
                      <tr>
                        <td style="font-family: sans-serif; font-size: 16px; vertical-align: top;">
                          ...
                          <p style="font-family: sans-serif; font-weight: normal; margin: 0; Margin-bottom: 15px; display: inline-block;">
                              ...
                              <div style="font-size: 40px; display: inline-block; margin-left: 8px; margin-right: 8px; font-weight: bold;  color: #00264d">
                              ${eventLocation}</div>
...
const sendGuestResultsEmail = function(email, hostName, eventDate, eventName, eventLocation, userId, eventId) { 
  transporter.sendMail(mailOptions(email, hostName, eventDate, eventName, eventLocation, userId, eventId), function(err, info){
  	console.log('sending results email to guest at : ' +email)
    if(err)
  		console.log(err)
  	else
  		console.log(info)
